		...
		*/
		...
		else
		{
			...
			else
			{
				...
				{
					echo 'You have supplied a wrong user/password combination. Or your account is pending approval. Please try again.';
				}
				else
				{
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						echo 'Welcome, ' . $_SESSION['user_name'] . '. <br /><a href="index_volunteer.php">Proceed to Your . Courtyard Gardens</a>.';
